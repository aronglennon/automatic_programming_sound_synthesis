...
INSERT INTO `parameters` VALUES (1,'similarity_measure',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(2,'gen_ops',NULL,NULL,'crossover',0.75,'subtree_mutation',0.25,NULL,NULL,NULL,NULL,NULL,'nlse','sic_dpla',NULL),(3,'gen_ops',NULL,NULL,'crossover',0.75,'point_mutation',0.25,NULL,NULL,NULL,NULL,NULL,'nlse','sic_dpla',NULL),(4,'gen_ops',NULL,NULL,'crossover',0.25,'subtree_mutation',0.75,NULL,NULL,NULL,NULL,NULL,'nlse','sic_dpla',NULL),(5,'gen_ops',NULL,NULL,'crossover',0.5,'subtree_mutation',0.25,'point_mutation',0.25,NULL,NULL,NULL,'nlse','sic_dpla',NULL),(6,'gen_ops',NULL,NULL,'crossover',0.5,'subtree_mutation',0.25,'reproduction',0.25,NULL,NULL,NULL,'nlse','sic_dpla',NULL),(7,'gen_ops',NULL,NULL,'crossover',0.25,'subtree_mutation',0.5,'reproduction',0.25,NULL,NULL,NULL,'nlse','sic_dpla',NULL);
...
--
-- Table structure for table `testdata_genops`
--

DROP TABLE IF EXISTS `testdata_genops`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `testdata_genops` (
  `id` int(11) NOT NULL,
  `testrun_id` int(11) DEFAULT NULL,
  `target_file` varchar(45) DEFAULT NULL,
  `patch_fitness` float DEFAULT NULL,
  `neighbor_fitness` float DEFAULT NULL,
  `patch` longtext,
  `neighbor` longtext,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Dumping data for table `testdata_genops`
--

LOCK TABLES `testdata_genops` WRITE;
/*!40000 ALTER TABLE `testdata_genops` DISABLE KEYS */;
/*!40000 ALTER TABLE `testdata_genops` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2013-04-22 20:14:39
