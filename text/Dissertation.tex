...
\caption[Subsequence Reordering Results]{Subsequence Reordering Results}
\end{center}
\end{figure}
...
\item In all other aspects, SIC-DPLA and DPLA have similar characteristics.
\end{itemize}
...
The results of using various genetic operator sets can be seen in Table 4.1 over each of the five `real-world' target timbres.
