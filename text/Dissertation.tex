...
In this research, our objective is to generate Max patches that are able to successfully produce audio that is timbrally similar to some target sound. In order to define a fitness measure for this objective, we need to have a definition of timbral similarity. Before we can discuss an objective timbral similarity metric, we first need to have a quantitative measure of timbre. Thus, the first task we face is choosing an appropriate timbre feature.
