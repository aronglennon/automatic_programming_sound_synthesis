...
Most importantly, my wife Lauren, and my children Henry, Jack, and Emily/Charles. I could write ten dissertations and still not be able to explain the true gravity of my love for you. 
\end{abstract}
...
The two resultant IC-DPLA distances are then summed together to provide the SIC-DPLAdistance ($D_{SIC-DPLA}$), which, as previously shown, is used to calculate our timbre sequence similarity measure, $S_T$.
