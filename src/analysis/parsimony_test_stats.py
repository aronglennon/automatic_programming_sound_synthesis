...
#testruns = [398, 401, 404]#[398, 401, 404, 416, 407]#, 420, 423, 426, 429, 432, 435, 438, 442, 445, 451, 454, 457, 460, 463, 466]
#testruns = [399, 402, 405]#[399, 402, 405, 417, 414]#, 421, 424, 427, 430, 433, 436, 440, 443, 446, 452, 458, 461, 464, 467]
testruns = [400, 403, 415]#[400, 403, 406, 419, 415]#, 422, 425, 428, 431, 434, 437, 441, 444, 449, 453, 456, 459, 462, 465, 468]
...
def main():
    ...
    for t in testruns:    
        ...
        generations = np.arange(0, 200, dtype=np.float)
        '''
        ...
        yExp = expfunc(trialX, *expParam)
        #yLin = linfunc(trialX, *linParam)
        #plt.plot(generations, max_fitness, '-',ls='--', linewidth = 1, label="%d" % t, hold = True)    
